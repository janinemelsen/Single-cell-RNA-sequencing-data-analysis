...
ggsave("ribo_merged_dimkpluis.tiff",plot = last_plot(),device = NULL,path = NULL,scale = 1,width = 6,height = 5,dpi = 300,limitsize = TRUE,bg = NULL,)
...
saveRDS(rescaled.NK_merged.ltnk, "merged_dimgzmkplus.rds")
